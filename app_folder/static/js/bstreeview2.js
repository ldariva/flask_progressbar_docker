...
; (function ($, window, document, undefined) {
    ...
    var pluginName = "bstreeview",
        defaults = {
            expandIcon: 'static/icons/outline_keyboard_arrow_down_black_48dp.png',//'fa fa-angle-down fa-fw',
            collapseIcon: 'static/icons/outline_navigate_next_black_48dp.png',//'fa fa-angle-right fa-fw',
            indent: 1.25,
    ...
    var templates = {
        ...
        treeviewItemStateIcon: '<img class="state-icon" >',
        treeviewItemIcon: '<img class="item-icon" >'
    ...
    $.extend(bstreeView.prototype, {
        ...
        init: function () {
            ...
            $(this.element).on('click', '.list-group-item', function (e) {
                $('.state-icon', this)
                    if ($('.state-icon', this).attr('src')==_this.settings.expandIcon){
                        $('.state-icon', this).attr('src',_this.settings.collapseIcon);
                    }else{
                        $('.state-icon', this).attr('src',_this.settings.expandIcon);
                    }
                    // .attr('src',_this.settings.expandIcon)
                    // .attr('src',_this.settings.collapseIcon);
